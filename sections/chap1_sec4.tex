...
\refcp{cp:introduction}では，本研究の背景について述べた．

\refcp{cp:related_work}では，関連研究について述べる．
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio, width=0.35\linewidth]{chap1/configuration.png}
  \caption{本論文の構成}
